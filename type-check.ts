...
export function tcStmt(env : GlobalTypeEnv, locals : LocalTypeEnv, stmt : Stmt<SourceLocation>) : Stmt<[Type, SourceLocation]> {
  switch(stmt.tag) {
    ...
    case "index-assign":
      ...
      return { ...stmt, a: [NONE, stmt.a], obj: typedObj, value: typedVal, index: typedIndex };
  }
}
...
export function tcExpr(env : GlobalTypeEnv, locals : LocalTypeEnv, expr : Expr<SourceLocation>) : Expr<[Type, SourceLocation]> {
  switch(expr.tag) {
    ...
    case "index":
      ...
      return { ...expr, a: [NONE, expr.a], obj: typedObj, index: typedIndex }; // TODO: update type annotation, needs to have list type
    case "call":
